...
should be the alphabet from a-z and the value should be
...
'''
pseudocode for above programme:
create an empty dictionary,
use a for loop to itrate from 97 to 122,
next use a dictionary builtin function setdefault then
print the code.'''

dict1 = {}
for ord in range(97,123):
   dict1.setdefault(chr(ord),ord)
print(dict1)
